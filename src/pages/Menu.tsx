        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-16 text-left">
          ...
          <div className="space-y-16">
            ...
            >
              ...
              <div className="space-y-8">
                {[
                  { name: "Green Juice", price: "R $7.00 | L $8.00", desc: "Kale, celery, green apple, lime, mint, ginger." },
                  { name: "Mixed Juice", price: "R $7.00 | L $8.00", desc: "Pineapple, orange, watermelon, passionfruit, kiwi." },
                  { name: "Fresh Orange Juice", price: "R $7.00 | L $8.00", desc: "100% fresh squeezed oranges." },
                  { name: "Fresh Watermelon Juice", price: "R $7.00 | L $8.00", desc: "100% fresh watermelon." },
